function checkPrenom()
{
    ...
    else
    {
        ...
        {
            m1.innerHTML        = "* Valeur incorrecte !";
            m1.style.color      = "red";
            m1.style.fontSize   = "18px";
...
function checkNom()
{
    ...
    else
    {
        ...
        {
            m2.innerHTML        = "* Valeur incorrecte !";
            m2.style.color      = "red";
            m2.style.fontSize   = "18px";
...
function checkEmail()
{
    ...
    else
    {
        ...
        {
            m3.innerHTML        = "* Valeur incorrecte !";
            m3.style.color      = "red";
            m3.style.fontSize   = "18px";
...
function checkTelephone()
{
    ...
    else
    {
        if(!isNaN(t.value))
        {
            ...
            {
                m4.innerHTML        = "* Valeur incorrecte !";
                m4.style.color      = "orange";
                m4.style.fontSize   = "18px";
                m4.style.fontWeight = "500";
                m4.style.marginLeft = "10px";
...
{
    let m    = document.getElementsByTagName("input")[4];
...
function enregistrer()
{
    ...
    let cn = checkNom();
    let ce = checkEmail();
    let ct = checkTelephone();
    let cc = checkPays();
    let cv = checkVille();
    let cm = checkMessage();
    if(cp == 1 && cn == 1 && ce == 1 && ct == 1 && cm == 1 && cc == 1 && cv == 1 && cm == 1)
    {
        s.disabled = false;
